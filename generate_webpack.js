...
/**/const tempFile = fs.readFileSync("browser/telegram.js", "utf8");
/**/let newTempFile = tempFile.replace(/"assert"/g, '"node:assert"');
/**/newTempFile = newTempFile.replace(/"buffer"/g, '"node:buffer"');
/**/newTempFile = newTempFile.replace(/"crypto"/g, '"node:crypto"');
/**/newTempFile = newTempFile.replace(/"fs"/g, '"node:fs"');
/**/newTempFile = newTempFile.replace(/"net"/g, '"node:net"');
/**/newTempFile = newTempFile.replace(/"path"/g, '"node:path"');
/**/newTempFile = newTempFile.replace(/"util"/g, '"node:util"');
/**/newTempFile = newTempFile.replace(/"stream"/g, '"node:stream"');
/**/fs.writeFileSync("browser/telegram.js", newTempFile, "utf8");
      console.log(
